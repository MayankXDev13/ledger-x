      ...
      <View className="bg-brand-card border border-brand-border rounded-3xl p-7 shadow-sm shadow-brand-dark">
        ...
        <View className="gap-5">
          ...
          <View className="gap-2">
            ...
            />
            {confirmError && (
              <Text className="text-[#EF4444] text-[13px] ml-1 font-medium">{confirmError}</Text>
            )}
          </View>
        ...
        <View className="flex-row justify-center mt-8 gap-2">
          ...
          <Pressable onPress={() => router.push("/auth/login")} className="active:opacity-70">
            <Text className="text-brand-accent text-[15px] font-bold">Sign In</Text>
          </Pressable>
        </View>
      </View>
